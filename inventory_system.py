...
from tkinter import ttk, messagebox #ttk - for better and advance looking widgets like pop up messages.
...
class InventorySystem: #Class Definition
    ...
    def add_setup(self):
        ...
        if self.serial_number_entry.get() == "": # "Serial number" or Inventory number.
    ...
    def edit_selected(self): #Loads selected setup into form for editing.
        ...
        for setup in self.inventory:
            ...
            if setup.serial_number == serial:

                self.edit_mode = True #Enables edit mode.
                self.editing_serial = serial
